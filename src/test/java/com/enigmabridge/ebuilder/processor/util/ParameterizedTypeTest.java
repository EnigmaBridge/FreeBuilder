...
public class ParameterizedTypeTest {
  ...
  private static final ClassTypeImpl MY_TYPE = ClassTypeImpl.newTopLevelClass("com.example.MyType");
  ...
  public void testFromDeclaredType_parameterWithSingleBound() {
    GenericElement myType = new GenericElement.Builder(MY_TYPE_NAME)
        .addTypeParameter("V", ClassTypeImpl.newTopLevelClass("java.lang.Number"))
        .build();
    ParameterizedType type = ParameterizedType.from(myType);
    assertEquals(MY_TYPE_NAME, type.getQualifiedName());
    assertTrue(type.isParameterized());
  ...
  public void testFromDeclaredType_parameterWithMultipleBounds() {
    GenericElement myType = new GenericElement.Builder(MY_TYPE_NAME)
        .addTypeParameter("V",
            ClassTypeImpl.newTopLevelClass("java.lang.Number"),
            ClassTypeImpl.newTopLevelClass("java.lang.Comparable"),
            ClassTypeImpl.newTopLevelClass("java.util.Formattable"))
        .build();
    ParameterizedType type = ParameterizedType.from(myType);
