...
public interface BehaviorTester {
  ...
  /**
   * Adds a {@link TestBuilder.TestSource} to compile and execute when {@link #runTest} is invoked.
   */
  BehaviorTester with(TestBuilder.TestSource testSource);
  ...
  public interface CompilationSubject {
     ...
     * been passed to {@link BehaviorTester#with(TestBuilder.TestSource)} prior to calling
