...
import com.enigmabridge.ebuilder.processor.util.testing.*;
...
public class BuildablePropertyFactoryTest {
  ...
  public void testMutateMethod() {
    assumeTrue("Environment has lambdas", features.get(FunctionPackage.FUNCTION_PACKAGE).consumer().isPresent());
    behaviorTester
        .with(new Processor(features))
        .with(DEFAULTS_TYPE)
        .with(new TestBuilder()
