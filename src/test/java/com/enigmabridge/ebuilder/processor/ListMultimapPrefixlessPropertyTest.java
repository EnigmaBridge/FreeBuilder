...
public class ListMultimapPrefixlessPropertyTest {
  ...
  private static final JavaFileObject MULTIMAP_PROPERTY = new SourceBuilder()
      ...
      .addLine("  public abstract %s<String, String> items();", Multimap.class)
      .addLine("")
  ...
  private static final JavaFileObject MULTIMAP_PRIMITIVE_KEY = new SourceBuilder()
      ...
      .addLine("@%s", FreeBuilder.class)
      .addLine("public abstract class DataType {")
      .addLine("  public abstract %s<Integer, String> items();", Multimap.class)
      .addLine("")
      .addLine("  public static class Builder extends DataType_Builder {}")
      .addLine("  public static Builder builder() {")
      .addLine("    return new Builder();")
  ...
  private static final JavaFileObject MULTIMAP_PRIMITIVE_VALUE = new SourceBuilder()
      ...
      .addLine("@%s", FreeBuilder.class)
      .addLine("public abstract class DataType {")
      .addLine("  public abstract %s<String, Character> items();", Multimap.class)
      .addLine("")
      .addLine("  public static class Builder extends DataType_Builder {}")
      .addLine("  public static Builder builder() {")
      .addLine("    return new Builder();")
  ...
  private static final JavaFileObject MULTIMAP_PRIMITIVES = new SourceBuilder()
      ...
      .addLine("@%s", FreeBuilder.class)
      .addLine("public abstract class DataType {")
      .addLine("  public abstract %s<Integer, Character> items();", Multimap.class)
      .addLine("")
      .addLine("  public static class Builder extends DataType_Builder {}")
      .addLine("  public static Builder builder() {")
      .addLine("    return new Builder();")
  ...
  public void testDefaultEmpty() {
    behaviorTester
        ...
        .with(testBuilder()
            ...
            .addLine("%s<String, String> foo = value.items();", Multimap.class)
  ...
  public void testDefaultEmpty_primitives() {
    behaviorTester
        ...
        .with(testBuilder()
            .addLine("DataType value = new DataType.Builder().build();")
            .addLine("%s<Integer, Character> foo = value.items();", Multimap.class)
            .addLine("assertThat(foo).isEmpty();")
            .build())
        .runTest();
  }
  ...
  public void testGet_returnsLiveView() {
    behaviorTester
        ...
        .with(testBuilder()
            ...
            .addLine("%s<String, String> itemsView = builder.items();", ListMultimap.class)
  ...
  public void testGet_returnsUnmodifiableMultimap() {
    ...
    behaviorTester
        ...
        .with(testBuilder()
            .addLine("DataType.Builder builder = new DataType.Builder();")
            .addLine("%s<String, String> itemsView = builder.items();", Multimap.class)
  ...
  @Test
  public void testImmutableMultimapProperty() {
    testPropertyOfMultimapSubclassType(ImmutableMultimap.class);
  }

  @Test
  public void testListMultimapProperty() {
    testPropertyOfMultimapSubclassType(ListMultimap.class);
  }

  @Test
  public void testImmutableListMultimapProperty() {
    testPropertyOfMultimapSubclassType(ImmutableListMultimap.class);
  }
  ...
  private void testPropertyOfMultimapSubclassType(Class<?> propertyType) {
    behaviorTester
        ...
        .with(new SourceBuilder()
            ...
            .addLine("@%s", FreeBuilder.class)
            .addLine("public abstract class DataType {")
            .addLine("  public abstract %s<String, String> items();", propertyType)
            .addLine("")
            .addLine("  public static class Builder extends DataType_Builder {}")
            .addLine("  public static Builder builder() {")
            .addLine("    return new Builder();")
  ...
  public void testJacksonInteroperability() {
    ...
    behaviorTester
        ...
        .with(new SourceBuilder()
            ...
            .addLine("  @JsonProperty(\"stuff\") %s<String, String> items();", Multimap.class)
            .addLine("")
        ...
        .with(testBuilder()
            ...
            .addLine("assertThat(clone.items())")
            .addLine("    .contains(\"one\", \"A\")")
            .addLine("    .and(\"two\", \"B\")")
            .addLine("    .andNothingElse()")
            .addLine("    .inOrder();")
