...
import com.enigmabridge.ebuilder.processor.util.PrimitiveTypeImpl;
...
public class GuavaOptionalSourceTest {
  ...
  private static Metadata createMetadataWithOptionalProperties() {
    GenericTypeElementImpl optional = GenericTypeElementImpl.newTopLevelGenericType("com.google.common.base.Optional");
    ClassTypeImpl integer = ClassTypeImpl.newTopLevelClass("java.lang.Integer");
    GenericTypeElementImpl.GenericTypeMirrorImpl optionalInteger = optional.newMirror(integer);
    ClassTypeImpl string = ClassTypeImpl.newTopLevelClass("java.lang.String");
    GenericTypeElementImpl.GenericTypeMirrorImpl optionalString = optional.newMirror(string);
    ...
    return metadata.toBuilder()
        ...
        .addProperties(name.toBuilder()
            .setCodeGenerator(new OptionalPropertyFactory.CodeGenerator(
                metadata, name, OptionalPropertyFactory.OptionalType.GUAVA, string, Optional.<TypeMirror>absent(), false))
            .build())
        .addProperties(age.toBuilder()
            .setCodeGenerator(new OptionalPropertyFactory.CodeGenerator(
                metadata, age, OptionalPropertyFactory.OptionalType.GUAVA, integer, Optional.<TypeMirror>of(PrimitiveTypeImpl.INT), false))
            .build())
        .build();
  }
