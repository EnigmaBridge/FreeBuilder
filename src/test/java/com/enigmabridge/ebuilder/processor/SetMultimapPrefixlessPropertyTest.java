...
public class SetMultimapPrefixlessPropertyTest {
  ...
  private static final JavaFileObject MULTIMAP_PRIMITIVE_KEY = new SourceBuilder()
      ...
      .addLine("@%s", FreeBuilder.class)
      .addLine("public abstract class DataType {")
      .addLine("  public abstract %s<Integer, String> items();", SetMultimap.class)
      .addLine("")
      .addLine("  public static class Builder extends DataType_Builder {}")
      .addLine("  public static Builder builder() {")
      .addLine("    return new Builder();")
  ...
  private static final JavaFileObject MULTIMAP_PRIMITIVE_VALUE = new SourceBuilder()
      ...
      .addLine("@%s", FreeBuilder.class)
      .addLine("public abstract class DataType {")
      .addLine("  public abstract %s<String, Character> items();", SetMultimap.class)
      .addLine("")
      .addLine("  public static class Builder extends DataType_Builder {}")
      .addLine("  public static Builder builder() {")
      .addLine("    return new Builder();")
  ...
  private static final JavaFileObject MULTIMAP_PRIMITIVES = new SourceBuilder()
      ...
      .addLine("@%s", FreeBuilder.class)
      .addLine("public abstract class DataType {")
      .addLine("  public abstract %s<Integer, Character> items();", SetMultimap.class)
      .addLine("")
      .addLine("  public static class Builder extends DataType_Builder {}")
      .addLine("  public static Builder builder() {")
      .addLine("    return new Builder();")
  ...
  public void testDefaultEmpty() {
    behaviorTester
        ...
        .with(testBuilder()
            ...
            .addLine("%s<String, String> foo = value.items();", SetMultimap.class)
  ...
  public void testDefaultEmpty_primitives() {
    behaviorTester
        ...
        .with(testBuilder()
            .addLine("DataType value = new DataType.Builder().build();")
            .addLine("%s<Integer, Character> foo = value.items();", SetMultimap.class)
            .addLine("assertThat(foo).isEmpty();")
            .build())
        .runTest();
  }
  ...
  public void testGet_returnsLiveView() {
    behaviorTester
        ...
        .with(testBuilder()
            ...
            .addLine("%s<String, String> itemsView = builder.items();", SetMultimap.class)
  ...
  public void testImmutableSetMultimapProperty() {
    behaviorTester
        ...
        .with(new SourceBuilder()
            ...
            .addLine("@%s", FreeBuilder.class)
            .addLine("public abstract class DataType {")
            .addLine("  public abstract %s<String, String> items();", ImmutableSetMultimap.class)
            .addLine("")
            .addLine("  public static class Builder extends DataType_Builder {}")
            .addLine("  public static Builder builder() {")
            .addLine("    return new Builder();")
  ...
  public void testJacksonInteroperability() {
    ...
    behaviorTester
        ...
        .with(new SourceBuilder()
            ...
            .addLine("  @JsonProperty(\"stuff\") %s<String, String> items();", SetMultimap.class)
            .addLine("")
