...
import static com.enigmabridge.ebuilder.processor.util.feature.GuavaLibrary.GUAVA;
import static org.junit.Assume.assumeTrue;

/** Behavioral tests for {@code List<?>} properties. */
@RunWith(Parameterized.class)
@UseParametersRunnerFactory(ParameterizedBehaviorTestFactory.class)
public class MapPrefixlessPropertyTest {
  ...
  private static final JavaFileObject PRIMITIVE_KEY_TYPE = new SourceBuilder()
      ...
      .addLine("@%s", FreeBuilder.class)
      .addLine("public interface DataType {")
      .addLine("  %s<Integer, String> items();", Map.class)
      .addLine("")
      .addLine("  class Builder extends DataType_Builder {}")
      .addLine("}")
      .build();
  ...
  private static final JavaFileObject PRIMITIVE_VALUE_TYPE = new SourceBuilder()
      ...
      .addLine("@%s", FreeBuilder.class)
      .addLine("public interface DataType {")
      .addLine("  %s<String, Double> items();", Map.class)
      .addLine("")
      .addLine("  class Builder extends DataType_Builder {}")
      .addLine("}")
      .build();
  ...
  private static final JavaFileObject PRIMITIVE_KEY_VALUE_TYPE = new SourceBuilder()
      ...
      .addLine("@%s", FreeBuilder.class)
      .addLine("public interface DataType {")
      .addLine("  %s<Integer, Double> items();", Map.class)
      .addLine("")
      .addLine("  class Builder extends DataType_Builder {}")
      .addLine("}")
      .build();
  ...
  public void testGet_returnsLiveView() {
    behaviorTester
        ...
        .with(new TestBuilder()
            ...
            .addLine("%s<String, Object> itemsView = builder.items();", Map.class)
  ...
  public void testImmutableMapProperty() {
    ...
    behaviorTester
        ...
        .with(new SourceBuilder()
            ...
            .addLine("@%s", FreeBuilder.class)
            .addLine("public interface DataType {")
            .addLine("  %s<String, Object> items();", ImmutableMap.class)
            .addLine("")
            .addLine("  class Builder extends DataType_Builder {}")
            .addLine("}")
            .build())
  ...
  public void testOverridingAdd_primitiveKey() {
    behaviorTester
        ...
        .with(new SourceBuilder()
            ...
            .addLine("@%s", FreeBuilder.class)
            .addLine("public interface DataType {")
            .addLine("  %s<Integer, Object> items();", Map.class)
            .addLine("")
            .addLine("  class Builder extends DataType_Builder {")
  ...
  public void testJacksonInteroperability() {
    ...
    behaviorTester
        ...
        .with(new SourceBuilder()
            ...
            .addLine("public interface DataType {")
            .addLine("  @JsonProperty(\"stuff\") %s<String, Object> items();", Map.class)
            .addLine("")
            .addLine("  class Builder extends DataType_Builder {}")
            .addLine("}")
            .build())
